          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-700 mt-2 list-disc list-inside space-y-1">
                ...
                <li></li><span className="blink-warning"> <span className="blink-icon">⚠️</span> Unduh template terbaru HANYA dari portal ini, JANGAN dari file lama/kiriman chat! </span></li>
              </ul>
            </div>
          </div>
        </div>
